...
class Results extends React.Component {
    ...
    getResults(){
        ...
        return (
            <>
            <p className = "results-text">Our wine expert recommends the following wines based on your responses:</p>
                    ...
                    <CardDeck className = "results-card">
                        <Card>
                            <Button
                                ...
                                >
                                Please read this page carefully and go back to survey (Qualtrics) to put code "W4"
                            </Button>
                        </Card>
